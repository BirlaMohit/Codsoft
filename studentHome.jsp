...
<%@page import="com.studentmanagement.codsoft.Connectionprovided"%>
 ...
 try
 {
	 ...
	 ResultSet rs=st.executeQuery("select *from management inner join result where management.rollNo=result.rollNo and management.rollNo='"+rollNo+"'");
     if(rs.next()){
%>
